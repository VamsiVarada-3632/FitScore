      ...
      <div className="relative" style={{ width: size, height: size }}>
        <svg width={size} height={size} style={{ transform: 'rotate(-90deg)' }}>
          ...
          <circle cx={size / 2} cy={size / 2} r={r} fill="none" stroke="#46f1c5"
            ...
            style={{ transition: 'stroke-dashoffset 1.8s cubic-bezier(0.16,1,0.3,1)', filter: 'drop-shadow(0 0 8px #46f1c580)' }} />
        </svg>
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <span className="font-mono font-bold text-primary" style={{ fontSize: size * 0.18 }}>{displayScore}</span>
